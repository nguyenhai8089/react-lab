            ...
            <div className='container'>
                 <div className='row-container'>
                    ...
                    <div className='div'>
                         ...
                         <p className="leader">{leader.description}</p>                  
        ...
        <div className='container'>
            ...
            <div className='row row-content' >
                 <div className='col-12 col-md-6'>
                       ...
                       <p>The restaurant traces its humble beginnings <em>to The Frying Pan, a successful</em> chain started by our CEO, Mr. Peter Pan, that featured for the first time the world's best cuisines in a pan.</p>
                 </div>
                 <div className='col-12 col-md-6'>
                     <Card>
